    ...
    <div class="scroll">
        <div class="row">
            <div class="center">
                ...
                <h1 class="heading">Секреты хлебопечки</h1>
            </div>
            <div class="line1">
                <div class="line2"></div>
            </div>
            <p class="lead">Секреты хлебопечки - это уютное место, где каждый день для вас пекут свежие и ароматные хлебобулочные изделия.
